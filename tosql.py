...
def add_score_cols(df):
    ...
    return pd.concat([df, inst_sentiment_col, assignments_score_col, overall_score_col, instructor_score_col, tests_score_col, course_sentiment_col, readings_score_col], axis = 1)
